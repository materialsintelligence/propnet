...
class FittingTests(unittest.TestCase):
    def setUp(self):
        ...
        graph = Graph()
        materials = [Material([Quantity.factory("band_gap", bg)])
    ...
    def test_get_sse(self):
        mats = [Material([Quantity.factory("band_gap", n)]) for n in range(1, 5)]

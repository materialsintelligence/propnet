...
class MaterialTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.q1 = Quantity.factory(DEFAULT_SYMBOLS['bulk_modulus'],
                           ureg.Quantity.from_tuple([200, [['gigapascals', 1]]]))
        self.q2 = Quantity.factory(DEFAULT_SYMBOLS['shear_modulus'],
                           ureg.Quantity.from_tuple([100, [['gigapascals', 1]]]))
        self.q3 = Quantity.factory(DEFAULT_SYMBOLS['bulk_modulus'],
    ...
    def test_add_default_quantities(self):
        ...
        self.assertEqual(list(material['temperature'])[0],
                         Quantity.factory("temperature", 300))
        self.assertEqual(list(material['relative_permeability'])[0],
                         Quantity.factory("relative_permeability", 1))
